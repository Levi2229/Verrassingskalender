...
namespace Verrassingskalender_Api.Services
{
    public class GridService : IGridService
    {
        ...
        {
            // Verklaring: Id 0 omdat we nu uigaan van 1 grid in DB, maar ondersteuning hebben voor meerdere grids met de huidige opzet.
        ...
        public async Task<CellContent> ScratchGridCell(ScratchGridCellRequest scratchGridCellRequest)
        {
            ...
            if (cell == null)
            {
                ...
                throw new Exception($"Cell with id {scratchGridCellRequest.CellId} not found.");
            }

            if (cell.Player != null)
            {
                throw new Exception($"Dit vakje is al opengekrast door speler {cell.Player}");
            }
